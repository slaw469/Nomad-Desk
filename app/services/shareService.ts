...
export const shareService = {
  ...
  generateShareText: (workspaceName: string, workspaceType: string, workspaceAddress: string): string => `Check out ${workspaceName}, a great ${workspaceType.toLowerCase()} for studying and working! Located at ${workspaceAddress}. Found on Nomad Desk.`,
