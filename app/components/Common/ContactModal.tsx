    ...
    <div style={modalStyles} onClick={handleBackdropClick}>
      <div style={contentStyles}>
        ...
        <div>
          ...
          <div style={{
            marginTop: '20px', padding: '15px', backgroundColor: '#F8FAFC', borderRadius: '8px',
          }}
          >
            <p style={{
              margin: 0, fontSize: '0.9rem', color: '#4B5563', lineHeight: '1.5',
            }}
            >
              <strong>Note:</strong>
              {' '}
              We're a discovery platform. Contact the workspace directly for availability,
