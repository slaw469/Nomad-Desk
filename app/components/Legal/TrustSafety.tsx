          ...
          <div style={styles.guidelinesList}>
            <div style={styles.guideline}>
              ...
              <p style={styles.guidelineText}>
                <strong>Honor Your Bookings:</strong>
                {' '}
                Arrive on time for your reservations and
            ...
            <div style={styles.guideline}>
              ...
              <p style={styles.guidelineText}>
                <strong>Leave Reviews Honestly:</strong>
                {' '}
                Share genuine feedback to help other
