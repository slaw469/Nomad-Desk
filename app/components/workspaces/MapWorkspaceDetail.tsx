...
import mapsService, { Location, PlaceDetailsResult } from '../../services/mapsService';
      ...
      try {
        ...
        const workspaceData: WorkspaceDetails = {
          ...
          photos: placeDetails.photos 
            ...
            : ['/api/placeholder/800/600?text=' + encodeURIComponent(placeDetails.name)],
    ...
    <div className={styles.workspaceContainer}>
      ...
      <div className={styles.workspaceGallery}>
        ...
        <div className={styles.galleryItem}>
          <img 
            src="/api/placeholder/400/200?text=Workspace" 
            alt={workspace.name} 
          />
        </div>
        <div className={styles.galleryItem}>
          <img 
            src="/api/placeholder/400/200?text=Interior" 
      ...
      <div className={styles.workspaceContent}>
        <div className={styles.workspaceDetails}>
          <div className={styles.tabs}>
            ...
            <div className={styles.tab}>Location</div>
          </div>
          ...
          <div className={styles.tabContent}>
            ...
            {workspace.reviews && workspace.reviews.length > 0 && (
              <div className={styles.tabSection} id="reviews">
                ...
                {workspace.reviews.length > 3 && (
                  <button className={styles.viewMoreButton}>
                    View all {workspace.reviews.length} reviews
                  </button>
                )}
              </div>
            )}
      ...
      <div className={styles.similarWorkspaces}>
        ...
        <div className={styles.workspaceCards}>
          {/* Sample similar workspaces - in a real app, these would be fetched based on location */}
          <div className={styles.workspaceCard}>
            <div className={styles.cardImage}>
              <Link to="/workspaces/2">
                <img src="/api/placeholder/400/250?text=Nearby+Cafe" alt="Nearby Cafe" />
              </Link>
            ...
            <div className={styles.cardContent}>
              ...
              <p className={styles.cardLocation}>0.5 miles away</p>
          ...
          <div className={styles.workspaceCard}>
            <div className={styles.cardImage}>
              <Link to="/workspaces/3">
                <img src="/api/placeholder/400/250?text=Nearby+Library" alt="Nearby Library" />
              </Link>
              <div className={styles.cardFavorite}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20.84 4.61C20.3292 4.099 19.7228 3.69364 19.0554 3.41708C18.3879 3.14052 17.6725 2.99817 16.95 2.99817C16.2275 2.99817 15.5121 3.14052 14.8446 3.41708C14.1772 3.69364 13.5708 4.099 13.06 4.61L12 5.67L10.94 4.61C9.9083 3.57831 8.50903 2.99871 7.05 2.99871C5.59096 2.99871 4.19169 3.57831 3.16 4.61C2.1283 5.64169 1.54871 7.04097 1.54871 8.5C1.54871 9.95903 2.1283 11.3583 3.16 12.39L4.22 13.45L12 21.23L19.78 13.45L20.84 12.39C21.351 11.8792 21.7563 11.2728 22.0329 10.6054C22.3095 9.93792 22.4518 9.22252 22.4518 8.5C22.4518 7.77748 22.3095 7.06208 22.0329 6.39464C21.7563 5.7272 21.351 5.12076 20.84 4.61Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <div className={styles.cardContent}>
              ...
              <p className={styles.cardLocation}>0.8 miles away</p>
              <div className={styles.cardAmenities}>
                <span className={styles.cardAmenity}>Library</span>
                <span className={styles.cardAmenity}>Study Rooms</span>
              </div>
              <div className={styles.cardFooter}>
          ...
          <div className={styles.workspaceCard}>
            <div className={styles.cardImage}>
              <Link to="/workspaces/4">
                <img src="/api/placeholder/400/250?text=Coworking+Hub" alt="Coworking Hub" />
              </Link>
              <div className={styles.cardFavorite}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20.84 4.61C20.3292 4.099 19.7228 3.69364 19.0554 3.41708C18.3879 3.14052 17.6725 2.99817 16.95 2.99817C16.2275 2.99817 15.5121 3.14052 14.8446 3.41708C14.1772 3.69364 13.5708 4.099 13.06 4.61L12 5.67L10.94 4.61C9.9083 3.57831 8.50903 2.99871 7.05 2.99871C5.59096 2.99871 4.19169 3.57831 3.16 4.61C2.1283 5.64169 1.54871 7.04097 1.54871 8.5C1.54871 9.95903 2.1283 11.3583 3.16 12.39L4.22 13.45L12 21.23L19.78 13.45L20.84 12.39C21.351 11.8792 21.7563 11.2728 22.0329 10.6054C22.3095 9.93792 22.4518 9.22252 22.4518 8.5C22.4518 7.77748 22.3095 7.06208 22.0329 6.39464C21.7563 5.7272 21.351 5.12076 20.84 4.61Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <div className={styles.cardContent}>
              <Link to="/workspaces/4" className={styles.cardTitle}>
                Innovation Hub
              </Link>
              <p className={styles.cardLocation}>1.2 miles away</p>
              <div className={styles.cardAmenities}>
                <span className={styles.cardAmenity}>Co-working</span>
                <span className={styles.cardAmenity}>Meeting Rooms</span>
              </div>
              <div className={styles.cardFooter}>
