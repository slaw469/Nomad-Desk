                  ...
                  <div className={styles.notificationContent}>
                    ...
                    {notification.relatedBooking && (
                      <div className={styles.relatedInfo}>
                        <CalendarIcon />
                        <span>
                          {notification.relatedBooking.workspaceName}
                          {' '}
                          -
                          {' '}
                          {notification.relatedBooking.date}
                          {' '}
                          at
                          {' '}
                          {notification.relatedBooking.time}
                        </span>
                      </div>
                    )}
                    ...
                    {notification.relatedSession && (
                      <div className={styles.relatedInfo}>
                        <CalendarIcon />
                        <span>
                          {notification.relatedSession.title}
                          {' '}
                          -
                          {' '}
                          {notification.relatedSession.date}
                          {' '}
                          at
                          {' '}
                          {notification.relatedSession.time}
                        </span>
                      </div>
                    )}
