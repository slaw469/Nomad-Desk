            ...
            {displayBookings.map((booking) => (
              <div key={booking.id} className={styles.bookingCard}>
                <div className={styles.bookingImage}>
                  <img
                    src={booking.workspace.photo || `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5003/api'}/placeholder/300/200`}
                    alt={booking.workspace.name}
                    onError={(e) => {
                      const target = e.target as HTMLImageElement;
                      target.src = `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5003/api'}/placeholder/300/200`;
                    }}
                  />
