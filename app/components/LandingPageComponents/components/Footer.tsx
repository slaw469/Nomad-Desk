  ...
  return (
    <footer>
      <div className="footer-content">
        <div className="footer-brand">
          <div className="footer-logo">
            ...
            <span className="footer-logo-text">NOMAD DESK</span>
          </div>
          <p className="footer-description">Find your perfect workspace anywhere. Nomad Desk connects students and remote workers with productive environments tailored to their needs.</p>
        ...
        <div className="footer-column">
          ...
          <div className="footer-links">
            <a href="#" className="footer-link">Find Spaces</a>
            <a href="#" className="footer-link">Create Study Group</a>
            <a href="#" className="footer-link">Libraries</a>
            <a href="#" className="footer-link">Coffee Shops</a>
            <a href="#" className="footer-link">Co-working Spaces</a>
          </div>
        </div>
        <div className="footer-column">
      ...
      <div className="footer-bottom">
        <div className="copyright">© 2025 Nomad Desk. All rights reserved.</div>
