  ...
  return (
    <section className="features">
      <div className="section-header">
        <h2 className="section-title">Why Choose Nomad Desk</h2>
        <p className="section-subtitle">Discover the perfect workspace tailored to your needs with our innovative platform designed for students, remote workers, and digital nomads.</p>
      </div>
      <div className="feature-cards">
        <div className="feature-card">
          ...
          <h3 className="feature-title">Verified Locations</h3>
          <p className="feature-description">Browse through thousands of curated and verified workspaces in libraries, cafes, hotels, and co-working spaces across the globe.</p>
        </div>
        <div className="feature-card">
          <div className="feature-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h3 className="feature-title">Create Study Groups</h3>
          <p className="feature-description">Easily organize and invite friends to join your study sessions. Collaborate efficiently in spaces designed for group work.</p>
        </div>
        <div className="feature-card">
          <div className="feature-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="feature-description">Check real-time availability and book spaces instantly. Filter by amenities like Wi-Fi, power outlets, quiet zones, and more.</p>
        </div>
      </div>
    </section>
  );
